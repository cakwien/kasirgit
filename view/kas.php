...
<body class="hold-transition skin-<?php if ($_SESSION['level']=="adm"){echo "green";}else{echo"blue";} ?> fixed sidebar-mini">
<div class="wrapper">
    ...
    <?php if ($_SESSION['level']=="adm")
       ...
       <li class="<?php if ($p=="initem"){echo "active";} else {echo"";} ?>">
          <a href="?p=initem">
           ...
           <li class="<?php if ($p=="setuser"){echo "active";}else {echo"";} ?>">
          <a href="?p=setuser">
